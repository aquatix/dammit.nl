...
THEME_CSS_OVERRIDES = [
    ...
    'https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@10.0.2/build/styles/darcula.min.css',
]
THEME_JS_OVERRIDES = [
    'https://cdn.jsdelivr.net/gh/highlightjs/cdn-release@10.0.2/build/highlight.min.js',
    '/js/dammit.js',
]
